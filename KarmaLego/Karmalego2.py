...
class KarmaLego:
    ...
    def run(self, entity_list):
        ...
        r = lego.run_lego(tree, entity_list)
        print("lego finish")
        return r
...
class Karma(KarmaLego):
    ...
    def run(self, entity_list):
        ...
        #return all non-repetitive events
        ...
        for entity_index, entity in enumerate(entity_list):
            ...
            # a list whose format like [(start,end, event)...] sorted by start
            ...
            for i in range(len(ordered_ti)):
                for j in range(i + 1, len(ordered_ti)):
                    ...
                    if symbol_1 in frequent_symbols and symbol_2 in frequent_symbols:
                        ...
                        # return a string of temporal relation
        ...
        # all_TIRPs_k2 is a list of tirp. Each tirp has two events, temporal relation, entity_index,
        # second indice of the entity with soecific event
        ...
        for tirp in all_TIRPs_k2:
            ...
            if tirp.vertical_support >= self.min_ver_supp:
                print('event: {}, temporal relation: {}'.format(tirp.symbols, tirp.relations[0]))
                # i = 0
                # if (cnt == 11359):
                #    print("hhh")
...
if __name__ == "__main__":
    ...
    f = open("/home/zhutou/project/karmalego/KarmaLego/non_sepsis_entity_list.data","rb")
    entity_list = pickle.load(f)
    # entity_list = read_json('/home/zhutou/project/karmalego/KarmaLego/entity_list.json')
#     entity_list = [
#     {
#         'A': [(2, 6), (12, 16)],
#         'B': [(4, 13)],
